 ...
 *
 * Continuous paragraphs only — the look wrapper handles line breaks.
 * Join paragraphs with %r%r (blank line between).
 *
...
// One continuous string per paragraph. No hard wraps inside a para.
const DESC = [
