...
const DESC = [
  ...
  "Coaches idle at the curb. A newspaper boy cries headlines no living paper ever printed. Somewhere a clock tower strikes an hour that may not be yours. When you are ready to leave the scene of play, %ch%cy+ooc%cn will take you to the lounge; %ch%cy+ic%cn brings you back to where you left, or here if you have no marker.",
].join("%r%r");
